...
public class ThenComposeDemo1 {
    ...
    public static void main(String[] args) {
        ...
        CompletableFuture<Integer> cf1 = getCompletableFuture(1);
        CompletableFuture<Integer> cf2 = getCompletableFuture(2);

        Integer total = cf1.thenCombine(cf2, (val1, val2) -> val1 + val2).join();
    ...
    private static CompletableFuture<Integer> getCompletableFuture(int number) {
