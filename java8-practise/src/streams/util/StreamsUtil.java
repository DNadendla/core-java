...
public class StreamsUtil {
    ...
    public static List<Employee> getEmployees() {
        ...
        employees.add(new Employee(1, "Alice", "IT", 30, pune, "Female", Arrays.asList(developer, tester), parseDate("2020-01-15"), parseDate("1990-05-10"), 75000.0));
        ...
        employees.add(new Employee(4, "Diana", "IT",32, losAngeles, "Female", new ArrayList<>(), parseDate("2017-02-14"), parseDate("1988-03-05"), 90000.0));
        employees.add(new Employee(5, "Eve", "IT",29, mumbai, "Female", new ArrayList<>(), parseDate("2020-07-19"), parseDate("1991-12-25"), 72000.0));
        employees.add(new Employee(6, "Frank", "FINANCE",27, pune, "Male", new ArrayList<>(), parseDate("2019-11-05"), parseDate("1993-04-11"), 72000.0));
        ...
        employees.add(new Employee(17, "Quinn", "IT",30, mumbai, "Female", new ArrayList<>(), parseDate("2020-08-12"), parseDate("1990-07-07"), 98000.0));
        employees.add(new Employee(18, "Rita", "IT",26, pune, "Female", new ArrayList<>(), parseDate("2022-05-01"), parseDate("1996-10-11"), 70000.0));
        employees.add(new Employee(19, "Steve", "HR",32, bangalore, "Male", new ArrayList<>(), parseDate("2018-04-09"), parseDate("1988-06-22"), 70000.0));
